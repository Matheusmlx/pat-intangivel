package br.com.azi.patrimoniointangivel.integrationtest.arquivo;
...
public class DownloadArquivoTest {
    ...
    public void deveRealizarDownloadDeArquivo() throws Exception{
        ...
        DownloadInputData inputData = DownloadInputData
            .builder()
            .uri("repo1:patrimoniointangivel/teste.pdf")
            .build();

        mockMvc.perform(
                get("/v1/arquivos?uri=repo1:patrimoniointangivel/teste.pdf&thumbnail=false")
    ...
    private void createMockRequisicaoBuscarMetadata() {
        ...
        wireMockRule.stubFor(WireMock.get(urlEqualTo("/setup/hal/public/arquivos/metadados?uri=repo1:patrimoniointangivel/teste.pdf"))
    ...
    private void createMockRequisicaoBuscarArquivo() {
        wireMockRule.stubFor(WireMock.get(urlEqualTo("/setup/hal/public/arquivos?uri=repo1:patrimoniointangivel/teste.pdf&thumbnail=false"))
            .willReturn(aResponse()
                .withStatus(200)));
    }
}
