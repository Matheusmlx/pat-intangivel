package br.com.azi.patrimoniointangivel.integrationtest.configuracao.parametro;
...
public class BuscarParametrosTest {
    ...
    @Test
    public void deveBuscarParametros() throws Exception{
        this.mockMvc
            .perform(
                get("/configuracao/parametros")
