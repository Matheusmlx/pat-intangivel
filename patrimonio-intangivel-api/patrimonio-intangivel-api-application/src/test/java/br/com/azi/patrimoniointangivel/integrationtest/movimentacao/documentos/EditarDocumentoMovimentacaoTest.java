...
public class EditarDocumentoMovimentacaoTest {
    ...
    @Test
    @Rollback
    @Sql({"/datasets/movimentacao/documento/editar-documento.sql"})
    @Transactional
    public void deveEditarDocumentoMovimentacao() throws Exception {
        createMockRequisicaoSetup();

        EditarDocumentoMovimentacaoInputData inputData = EditarDocumentoMovimentacaoInputData
            .builder()
        ...
        mockMvc.perform(
            put("/movimentacao/1/documentos/1")
