...
@Transactional
public class CriarDocumentoTest {
    ...
    @Test
    @Rollback
    @Sql({"/datasets/movimentacao/documento/cadastrar-documento.sql"})
    @Transactional
    public void deveCriarDocumento() throws Exception{
        ...
        mockMvc.perform(
            post("/movimentacao/1/documentos")
