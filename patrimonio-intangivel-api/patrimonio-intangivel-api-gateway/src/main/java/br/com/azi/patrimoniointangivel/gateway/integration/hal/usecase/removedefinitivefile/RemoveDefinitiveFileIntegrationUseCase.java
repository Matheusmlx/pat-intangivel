package br.com.azi.patrimoniointangivel.gateway.integration.hal.usecase.removedefinitivefile;
...
import br.com.azi.patrimoniointangivel.domain.gateway.integration.exception.RemocaoArquivoException;
...
public class RemoveDefinitiveFileIntegrationUseCase {
    ...
    private String getMediaType(ResponseBody body, String fileUri) {
        ...
        return br.com.azi.patrimoniointangivel.utils.misc.MediaType.findMIMETypeBy(extractFileExtention(fileUri));
    }
