...
@NoArgsConstructor
@Entity
@Table(name = "TB_NOTA_LANCTO_CONTABIL" ,schema = "PAT_INTANGIVEL")
@SequenceGenerator(name = "SEQ_NOTA_LANCTO_CONTABIL", sequenceName = "PAT_INTANGIVEL.SEQ_NOTA_LANCTO_CONTABIL", allocationSize = 1)
@AttributeOverrides({
