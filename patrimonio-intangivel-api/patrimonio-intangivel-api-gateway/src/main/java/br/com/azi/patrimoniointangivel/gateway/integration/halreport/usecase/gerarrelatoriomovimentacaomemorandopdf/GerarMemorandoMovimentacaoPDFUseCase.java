package br.com.azi.patrimoniointangivel.gateway.integration.halreport.usecase.gerarrelatoriomovimentacaomemorandopdf;
...
@Component
public class GerarMemorandoMovimentacaoPDFUseCase {

    private static final String NOME_RELATORIO ="relatoriomemorandomovimentacao";
    ...
    public Arquivo executar(HalReportIntegrationProperties integrationProperties, RelatorioMemorandoMovimentacao relatorio){
    ...
    private Map<String, Object> configurarDataSouce(HalReportIntegrationProperties integrationProperties, RelatorioMemorandoMovimentacao relatorio){
